...
const points = [
  { icon: UserCheck, title: "Réseau d'experts sélectionnés", text: "Des professionnels rigoureusement sélectionnés et chaleureusement recommandés par nos clients." },
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:gap-16 md:px-8">
        ...
        <Reveal delay={120}>
          ...
          <p className="mt-6 text-pretty leading-relaxed text-muted-foreground">
            A-Z est un service complet couvrant chaque aspect de votre parcours immobilier à Jérusalem :<br />du soutien juridique au financement, en passant par la planification et le design au plus haut niveau, avec une connexion directe aux fournisseurs locaux et importateurs sélectionnés - sans intermédiaires et à des prix que vous ne trouverez nulle part ailleurs. Nous veillons à ce que chaque étape soit fluide, sécurisée et gérée par les meilleurs professionnels, chaleureusement recommandés par nos anciens clients.
          </p>
